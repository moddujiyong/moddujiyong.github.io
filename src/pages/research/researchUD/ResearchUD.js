    ...
    <div className="researchUD" >
      <div className="ud-header" >
        ...
        <div className="ud-scrollMenu">
           <ul className="udList">
            <li className="udListItem" onClick={onAllResUDClick}style={{color: choose === 'All' ? 'black' : 'grey'}} >All</li>
            <li className="udListItem" onClick={onProgResUDClick}style={{color: choose === 'Progressing' ? 'black' : 'grey'}} >Progressing</li>
            <li className="udListItem" onClick={onClosingResUDClick}style={{color: choose === 'Closed' ? 'black' : 'grey'}} >Closed</li>
