       ...
       <div className="prof-summary">
          ...
          <div className="prof-field">
            ...
            <div className="research-interest">
              ...
              <span className="ril">Medical devices usability engineering</span>
              <span className="ril">Medical devices UX/UI design and evaluation</span>
              <span className="ril">Medical image diagnostic system</span>
              <span className="ril">Biosignal processing and diagnostic algorithm</span>
              <span className="ril">Medical devices industry policies</span>
