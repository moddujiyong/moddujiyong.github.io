  ...
  return (   
    <div className="intern" >
      ...
      <div className="intern-info" >
        ...
        <span className="iilt">
          Sangeun Park 
          <span className="iild">(2018.09.01 ~ 2019.02.28)</span> 
        </span>
        ...
        <span className="iilt">
        Insik Im
          <span className="iild">(2018.09.01 ~ 2018.12.31)</span> 
        </span>
        <span className="iil"> Department of Medical Device Engineering & Management, Graduate School, College of Medicine, Yonsei University </span>

        <span className="iilt">
        Kyungpil Kang 
          <span className="iild">(2018.10.01 ~ 2018.12.31)</span> 
        </span>
        <span className="iil"> Department of Medical Device Engineering & Management, Graduate School, College of Medicine, Yonsei University</span>

        <span className="iilt">
        Hanji Lee
          <span className="iild">(2019.07-2020.02.28)</span> 
        </span>
        <span className="iil"> Department of Medical Device Engineering & Management, Graduate School, College of Medicine, Yonsei University</span>

        <span className="iilt">
        Jeonguk Choi
          <span className="iild">(2019.07.01 ~ 2019.08.31)</span> 
        </span>
        ...
        <span className="iilt">
        Choro Choi
          <span className="iild">(2019.09.01 ~ 2020.08.31)</span> 
        </span>
        <span className="iil"> Department of Medical Device Engineering & Management, Graduate School, College of Medicine, Yonsei University</span>

        <span className="iilt">
        Minha Kim 
          <span className="iild">(2020.01.01 ~ 2020.02.28)</span> 
        </span>
        ...
        <span className="iilt">
        Heeyeong Choi
          <span className="iild">(2020.07.01 ~ 2021.02.28)</span> 
        </span>
        <span className="iil">  Department of Medical Device Engineering & Management, Graduate School, College of Medicine, Yonsei University</span>

        <span className="iilt">
        Jeonghwa Lim
          <span className="iild">(2020.07.01 ~ 2020.12.31)</span> 
        </span>
        <span className="iil">Department of Medical Device Engineering & Management, Graduate School, College of Medicine, Yonsei University </span>
